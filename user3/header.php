                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <a href="javascript: void(0);">
                                 <i class="fas fa-address-book"></i>
                                    ...
                                    // Assuming you want to count the number of resumes for the current user
                                     $resume_result = $dbcon->query("SELECT COUNT(*) AS total_resumes FROM resumes WHERE email = '$email'");
                                     $resume_row = $resume_result->fetch_assoc();
                                     echo $resume_row['total_resumes'];
                                     ?>
                                     </span>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="resume_update.php">Update Resume</a></li>
                                </ul>
                            </li>
                    ...
                    <nav class="navbar-custom">
                        ...
                        <ul class="list-inline menu-left mb-0">
                            ...
                            <li>
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index3.php">Portfolio</a></li>
