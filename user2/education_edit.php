...
if(isset($_POST['submit'])){
	...
	if(!empty($degree_name) &&!empty($year) && !empty($progressbar)){
		$work_insert = $dbcon->query("INSERT INTO education_informations(degree_name, degree_information, year, progressbar) VALUES ('$degree_name', '$degree_information', '$year', '$progressbar')");
		if($work_insert){
	  ...
	  <div class="card-body">
			...
			<form action="" method="post" >
				<div class="form-group">
					<label for="project_name">School Name</label>
					<input type="text" class="form-control" name="degree_name">
				</div>

				<div class="form-group">
					<label for="project_name">Degree Information</label>
					<input type="text" class="form-control" name="degree_information">
				</div>
