...
if(isset($_POST['submit'])){
	...
	$degree_information = $_POST['degree_information'];
	$year              = $_POST['year'];
	$progressbar       = $_POST['progressbar'];
	

	if(!empty($degree_name) &&!empty($year) && !empty($progressbar)){
		$education_update = $dbcon->query("UPDATE education_informations SET degree_name='$degree_name', degree_information='$degree_information',year='$year',progressbar='$progressbar' WHERE id='$id'");
                                ...
                                <div class="card-box">
                                    <h4 class="header-title mb-4">Add Degree</h4>
																			...
																			<form action="" method="post" >
																				...
																				<div class="form-group">
																					<label for="project_name">Degree Information</label>
																					<input type="text" class="form-control" name="degree_information" value="<?=$education_data['degree_information']?>">
																				</div>
